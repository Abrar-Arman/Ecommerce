  ...
  return (
    <Container>
      ...
      <Button onClick={()=>{
        navigate('/products');
         window.scrollTo(0, 0);
      }} className="cursor-pointer px-10 py-6 hover:scale-[1.1] transition duration-300  font-medium font-Outfit italic bg-c-secondary hover:bg-c-secondary text-lg">
        Show More</Button>
      </div>
    </Container>
  );
