      ...
      <Container margin={false}>
        <div className='grid grid-cols-3 gap-x-4 gap-y-8 '>
          ...
          <div className='text-center'>
            <h2 className='font-semibold text-[#5A5A5A] mb-2 text-lg sm:text-xl'>COMPANY</h2>
            <nav>
              <ul className='flex flex-col gap-y-2.5 text-lg text-[#595959]'>
                <li>
          ...
          <div className='text-center col-span-2 md:col-span-1'>
             <h2 className='font-semibold text-[#5A5A5A] mb-2 text-lg sm:text-xl'>GET IN TOUCH</h2>
